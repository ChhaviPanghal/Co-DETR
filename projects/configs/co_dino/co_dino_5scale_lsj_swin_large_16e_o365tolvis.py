...
load_from = 'models\co_dino_5scale_lsj_swin_large_16e_o365tolvis.pth'
pretrained = 'models\co_dino_5scale_lsj_swin_large_16e_o365tolvis.pth'
# model settings
model = dict(
    query_head=dict(
        dn_cfg=dict(
